...
class ApiPolicyMatrix
{
    ...
    public static function all(): array
    {
        return [
            ...
            'api/csp-report.php' => ['auth' => 'public', 'permission' => null],
            'api/delete_bank.php' => ['auth' => 'permission', 'permission' => 'bank_manage'],
            'api/delete_banks_bulk.php' => ['auth' => 'permission', 'permission' => 'bank_manage'],
            'api/delete_supplier.php' => ['auth' => 'permission', 'permission' => 'supplier_manage'],
            'api/delete_suppliers_bulk.php' => ['auth' => 'permission', 'permission' => 'supplier_manage'],
            ...
            'api/evidence-file.php' => ['auth' => 'permission', 'permission' => 'import_excel'],
            ...
            'api/get-timeline-view-state.php' => ['auth' => 'permission', 'permission' => 'timeline_view'],
            ...
            'api/attachment-file.php' => ['auth' => 'permission', 'permission' => 'attachments_view'],
